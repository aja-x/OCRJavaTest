 ...
 * @author yuuki
 */
public class VProfileAdminFrame extends javax.swing.JFrame {

    /**
     * Creates new form DashboardFrame
     */
    TbUser session_user;
    public VProfileAdminFrame() {
        initComponents();
    }
    public VProfileAdminFrame(TbUser session_user) {
    ...
    private void initComponents() {
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/testocr/img/user.png"))); // NOI18N
        ...
        jButton5.setBackground(jPanel3.getBackground());
        ...
        columnBinding.setColumnName("Nohp");
        columnBinding.setColumnClass(String.class);
        ...
        jButton6.setBackground(jPanel4.getBackground());
        ...
        jButton6.setPreferredSize(new java.awt.Dimension(154, 33));
        ...
        jPanel1.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 70, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VProfileAdminFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VProfileAdminFrame().setVisible(true);
            }
        });
    }
