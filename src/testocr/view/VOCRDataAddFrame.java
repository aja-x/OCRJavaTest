 ...
 * @author yuuki
 */
public class VOCRDataAddFrame extends javax.swing.JFrame {
    ...
    TbUser session_user;
    String content;
    public VOCRDataAddFrame() {
        initComponents();
    }
    public VOCRDataAddFrame(TbUser session_user) {
    ...
    private void initComponents() {
        ...
        jLabel7.setText("App / OCR Data / Add");
        ...
        jPanel4.setPreferredSize(new java.awt.Dimension(120, 33));
        ...
        jPanel1.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 350, -1, 33));
        ...
        jPanel1.add(jPanel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 350, 120, -1));
        ...
        jPanel9.setPreferredSize(new java.awt.Dimension(120, 33));
        ...
        jPanel1.add(jPanel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 350, -1, -1));

        jTextArea1.setColumns(20);
        jTextArea1.setRows(5);
        jTextArea1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(153, 153, 153), 2));
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        if(result == JFileChooser.APPROVE_OPTION){
            ...
            Image image = getScaledImage(awal.getImage(),img.getWidth(),img.getHeight());
            //menampilkan gambar
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VOCRDataAddFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VOCRDataAddFrame().setVisible(true);
            }
        });
    }
