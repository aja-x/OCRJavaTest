 ...
 * @author yuuki
 */
public class VOCRDataFrame extends javax.swing.JFrame {

    /**
     * Creates new form DashboardFrame
     */
    TbUser session_user;
    public VOCRDataFrame() {
        initComponents();
    }
    public VOCRDataFrame(TbUser session_user) {
    ...
    private void initComponents() {
        ...
        if(session_user.getLevel().equals("user")){
            tbImageQuery = java.beans.Beans.isDesignTime() ? null : persistanceEntityManager.createQuery("SELECT t FROM TbImage t WHERE t.userUsername.username = '" +session_user.getUsername()+"'");
        }else{
        ...
        org.jdesktop.swingbinding.JTableBinding jTableBinding = org.jdesktop.swingbinding.SwingBindings.createJTableBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, tbImageList, jTable1);
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 110, 650, 290));
        ...
        jPanel1.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 70, -1, 33));
        ...
        jPanel1.add(jPanel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 70, -1, -1));
        ...
        jPanel1.add(jButton7, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 70, 154, 33));
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        int id = Integer.parseInt(jTable1.getValueAt(row, coloum).toString());
        
        DaoTbResult daoTbResult = new DaoTbResult(TbResult.class);
        TbResult tbResult = daoTbResult.findById(id);
        
        new VOCRDataDetailFrame(session_user, tbResult).setVisible(true);
        this.setVisible(false);
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        new VOCRDataAddFrame(session_user).setVisible(true);
        this.setVisible(false);
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        TbImage tbImage = daoTbImage.findById(id);
        daoTbImage.delete(id);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VOCRDataFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VOCRDataFrame().setVisible(true);
            }
        });
    }
